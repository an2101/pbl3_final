  ...
  (function (factory) {
    ...
    /** @lends <global> */ function ($) {
      ...
      var _htmlNumeric = function (d, formatted) {
        ...
        var html = _isHtml(d);
        return !html ? null : _isNumber(_stripHtml(d), formatted) ? true : null;
      };
      ...
      function _fnAjaxParameters(settings) {
        ...
        data.__legacy = true;
        return settings.sAjaxSource || DataTable.ext.legacy.ajax ? data : d;
      }
      ...
      function _fnFeatureHtmlLength(settings) {
        ...
        div.children().append(a[0]).append(select).append(a[2]);

        select.val(settings._iDisplayLength).bind("change.DT", function (e) {
      ...
      function _fnScrollDraw(settings) {
        ...
        if (scroll.bCollapse && scrollY !== "") {
          divBodyStyle.height =
            divBody.offsetHeight + header[0].offsetHeight + "px";
        }
      ...
      function _fnSaveState(oSettings) {
        ...
        oSettings.fnStateSaveCallback.call(
          oSettings.oInstance,
          oSettings,
          oState
        );
      ...
      function _fnLoadState(oSettings, oInit) {
        ...
        var oData = oSettings.fnStateLoadCallback.call(
          oSettings.oInstance,
          oSettings
        );
        if (!oData) {
        ...
        if (
          oData.iCreate <
          new Date().getTime() - oSettings.iStateDuration * 1000
        ) {
          return;
        }
        ...
        reduce:
          ...
          function (fn, init) {
            ...
            for (var i = 0, ien = this.length; i < ien; i++) {
              ...
              value = isSet ? fn(value, this[i], i, this) : this[i];
      ...
      var __details_events = function (settings) {
        ...
        if (_pluck(settings.aoData, "_details").length > 0) {
          ...
          table.on(
            "column-visibility.DT_details",
            function (e, settings, idx, vis) {
              // Update the colspan for the details rows (note, only if it already has
              // a colspan)
              var row,
                visible = _fnVisbleColumns(settings);
      ...
      DataTable.defaults = {
        ...
        fnFormatNumber: function (toFormat) {
          return toFormat
            .toString()
            .replace(/\B(?=(\d{3})+(?!\d))/g, this.oLanguage.sInfoThousands);
        },
